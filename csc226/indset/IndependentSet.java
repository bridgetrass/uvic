...
public class IndependentSet{
	...
	*/
	static VertexSet MaximumIndependentSet(int[][] G){
		...
		// create set B to store best set 
		VertexSet B = new VertexSet(numVerts);
		// F represents forbidden vertices
	...
	static void FindSets(int[][] G,VertexSet B,VertexSet S,VertexSet F,int v){
		...
		VertexSet newF = new VertexSet(n);
		newF.copyFrom(F);
		newF.addVertex(v);
		
		//recurse (v is not added
		FindSets(G,B,S,newF, v+1);
